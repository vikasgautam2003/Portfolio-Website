...
//       className="flex flex-col gap-6 items-center justify-center min-h-screen w-full px-4 z-[20]"
//     >
//       <motion.div
...
//         <motion.p variants={fadeInVariants} className="text-lg sm:text-xl text-gray-300 max-w-lg mt-2">
...
//           variants={fadeInVariants}
//           href="#contact"
//           className="mt-6 py-3 px-8 bg-gradient-to-r from-purple-500 to-cyan-500 text-white font-semibold rounded-lg shadow-lg hover:scale-105 transition-transform duration-300 cursor-pointer"
//         >
//           Get In Touch
//         </motion.a>
//       </div>
