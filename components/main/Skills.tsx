...
export const skills: Skill[] = [
  ...
  { name: "Tailwind CSS", image: "/logos/Tailwind.svg", category: "Frontend", description: "Utility-first CSS framework for rapid UI development." },
  { name: "WebRTC", image: "/logos/webrtc.svg", category: "Frontend", description: "Real-time communication for audio, video, and data." },

  { name: "Node.js", image: "/logos/nodejs.svg", category: "Backend", description: "JavaScript runtime for building servers." },
  { name: "FastAPI", image: "/logos/Fastapi.svg", category: "Backend", description: "High-performance Python framework for APIs." },
  ...
  { name: "Supabase", image: "/logos/supabase.svg", category: "Backend", description: "Firebase alternative built on PostgreSQL." },
  { name: "MCP Servers", image: "/logos/mcp.svg", category: "Backend", description: "Modular, tool-based server architecture for LLMs." },
  ...
  { name: "NGINX", image: "/logos/NGINX.svg", category: "DevOps", description: "High-performance web server & reverse proxy." },
  ...
  { name: "Postman", image: "/logos/Postman.svg", category: "DevOps", description: "API testing & collaboration platform." },

  { name: "Gemini API", image: "/logos/gemini.svg", category: "AI", description: "Access Google's powerful generative models." },
  { name: "Groq API", image: "/logos/groq.svg", category: "AI", description: "High-speed inference API for running LLMs blazingly fast." },
  { name: "Llama 3 API", image: "/logos/llama.svg", category: "AI", description: "Meta's powerful open-source LLM family." },
  { name: "SerpApi", image: "/logos/serp.png", category: "AI", description: "Real-time Google Search API for data extraction." },
  { name: "LangChain", image: "/logos/langchain.svg", category: "AI", description: "Framework for developing LLM applications." },
  { name: "LangGraph", image: "/logos/langgraph.svg", category: "AI", description: "Graph-based framework for building agentic workflows." },
  ...
  { name: "spaCy", image: "/logos/Spacy.svg", category: "AI", description: "Industrial-strength NLP library." },
  { name: "Pandas", image: "/logos/Pandas.svg", category: "AI", description: "Powerful data analysis and manipulation library." },
  { name: "NumPy", image: "/logos/numpy.svg", category: "AI", description: "Fundamental package for numerical computing in Python." },
  { name: "Matplotlib", image: "/logos/matplotlib.svg", category: "AI", description: "2D plotting library for Python & data visualization." },
