...
//     description: "A place where students or even professional can learn from courses.",
//     image: "/development.jpg",
//     link: "https://vchess.example.com",
//   },
// ];

// const Project = () => {
//   return (
//     <section className="py-16 px-4 md:px-10 text-white relative z-10">
...
//             <div
//               key={project.id}
//               className="bg-gray-900/80 backdrop-blur-sm rounded-2xl shadow-lg overflow-hidden hover:shadow-purple-500/30 hover:scale-105 transition-transform duration-300"
//             >
//               {/* Image */}
