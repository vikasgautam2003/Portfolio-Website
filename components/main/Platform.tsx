...
//   tech: string[];
// }
// interface HFItem extends ShowcaseItem {}
// interface Container extends ShowcaseItem {}
// interface Platform {
//   id: number;
//   name: string;
//   logo: string;
...
//   panelImage: string; // New field for the modal's left panel background
//   link: string;
//   details: {
//     showcase: {
//       title: string;
...
// // --- PLATFORM DATA (UPDATE WITH YOUR INFO) ---
...
//     // ## FIX: Dummy image for panel background with high opacity for testing
...
//   return (
//     <section className="py-32 text-white relative z-10 bg-transparent">
//       <div className="max-w-7xl mx-auto px-4">
//         <motion.h2 initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }} className="text-5xl md:text-7xl font-bold text-center mb-24 tracking-tighter">
...
//               className="relative aspect-[4/5] rounded-3xl overflow-hidden cursor-pointer group shadow-2xl"
...
//               <motion.div whileHover={{ rotateX: 10, rotateY: -10 }} transition={{ duration: 0.4, ease: "easeOut" }} className="relative z-10 w-full h-full flex flex-col justify-end p-8 text-white">
//                 <img src={platform.logo} alt={`${platform.name} logo`} className="w-16 h-16 mb-4"/>
//                 <h3 className="text-4xl font-bold tracking-tight">{platform.name}</h3>
...
//       <AnimatePresence>
//         {selectedPlatform && (
//           <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="fixed inset-0 bg-black/50 backdrop-blur-xl z-50 flex">
//             {/* Left Panel */}
//             <motion.div 
//               initial={{ x: "-100%" }} animate={{ x: "0%" }} exit={{ x: "-100%" }}
//               transition={{ duration: 0.6, ease: [0.22, 1, 0.36, 1] }}
//               className="w-full md:w-1/3 h-full border-r border-white/10 p-8 md:p-12 flex flex-col pt-24 pb-12 relative"
//             >
//               {/* ## FIX: Used panelImage with opacity-30 for testing */}
...
//                 <img src={selectedPlatform.logo} alt={`${selectedPlatform.name} logo`} className="w-24 h-24 mb-6"/>
//                 <h2 className="text-5xl font-bold mb-4 tracking-tighter">{selectedPlatform.name}</h2>
//                 <p className="text-gray-300 text-lg mb-12 flex-grow">{selectedPlatform.description}</p>
//                 <a href={selectedPlatform.link} target="_blank" rel="noopener noreferrer" className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 px-8 py-4 rounded-full text-white text-lg font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg">
...
//               className="w-full md:w-2/3 h-full overflow-y-auto relative"
//             >
...
//               <div className="relative p-8 md:p-12 pt-24 pb-12">
//                 <button onClick={() => setSelectedPlatform(null)} className="absolute top-8 right-8 text-white z-50 p-2 rounded-full hover:bg-white/10 transition-colors">
//                   <CloseIcon />
//                 </button>
                
//                 <div className="space-y-12">
//                   <div className="space-y-6">
//                     <h3 className="text-4xl font-bold text-white border-b border-white/10 pb-4">{selectedPlatform.details.showcase.title}</h3>
...
//                     <div>
//                       <h3 className="text-3xl font-bold mb-4 text-white">Featured Repositories</h3>
...
//                     <div>
//                       <h3 className="text-3xl font-bold mb-4 text-white">Featured Models</h3>
//                       <div className="bg-slate-800/50 rounded-lg border border-white/10">
...
//                     <div>
//                       <h3 className="text-3xl font-bold mt-12 mb-4 text-white">Featured Datasets</h3>
//                       <div className="bg-slate-800/50 rounded-lg border border-white/10">
...
//                     <div>
//                       <h3 className="text-3xl font-bold mt-12 mb-4 text-white">Featured Spaces</h3>
//                       <div className="bg-slate-800/50 rounded-lg border border-white/10">
...
//                     <div>
//                       <h3 className="text-3xl font-bold mb-4 text-white">Top Container Images</h3>
//                       <div className="bg-slate-800/50 rounded-lg border border-white/10">
